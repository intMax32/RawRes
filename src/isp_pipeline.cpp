                                      ...
                                      float eps)
{
    ...
    else if (pCh == 3) // Color input image
    {
        ...
        cv::Mat IPBlue = I.mul(meanOfPBlue);
        cv::Mat IPGreen = I.mul(meanOfPGreen);
        cv::Mat IPRed = I.mul(meanOfPRed);
        ...
        cv::multiply(meanOfABlue, I, qGreen);
        cv::multiply(meanOfABlue, I, qRed);
        qBlue += bBlue;
        qGreen += bGreen;
        qRed += bRed;
